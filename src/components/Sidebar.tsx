...
export const Sidebar = ({ onPlaylistSelect, selectedPlaylist }: SidebarProps) => {
  return (
    <div className="w-64 bg-sidebar flex flex-col h-full hidden md:flex">
      <div className="p-6">
        <h1 className="text-2xl font-bold text-foreground mb-8">
          <svg className="w-32" viewBox="0 0 1134 340" xmlns="http://www.w3.org/2000/svg">
        ...
        <nav className="space-y-2">
          <button className="flex items-center gap-4 text-foreground hover:text-foreground transition-colors w-full px-3 py-2 rounded-md hover:bg-hover">
            <Home size={24} />
            <span className="font-bold text-sm">Home</span>
          </button>
          <button className="flex items-center gap-4 text-muted-foreground hover:text-foreground transition-colors w-full px-3 py-2 rounded-md hover:bg-hover">
            <Search size={24} />
        ...
        <div className="mt-6 space-y-2">
          <button className="flex items-center gap-4 text-muted-foreground hover:text-foreground transition-colors w-full px-3 py-2 rounded-md hover:bg-hover">
            <div className="w-6 h-6 bg-muted-foreground flex items-center justify-center rounded-sm">
              <Plus size={16} />
            </div>
            <span className="font-bold text-sm">Create Playlist</span>
          </button>
          <button className="flex items-center gap-4 text-muted-foreground hover:text-foreground transition-colors w-full px-3 py-2 rounded-md hover:bg-hover">
            <div className="w-6 h-6 bg-gradient-to-br from-purple-400 to-blue-400 flex items-center justify-center rounded-sm">
            ...
            {playlists.map((playlist) => (
              <button
                ...
                className={`text-sm hover:text-foreground transition-colors block w-full text-left ${
                  selectedPlaylist === playlist.id ? 'text-foreground' : 'text-muted-foreground'
                }`}
              >
                {playlist.name}
              </button>
